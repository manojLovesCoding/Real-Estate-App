...
const Testimonails = () => {
    return (
        <motion.div
            ...
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline-offset-4 decoration-1 under font-light'>Testimonails</span></h1>
